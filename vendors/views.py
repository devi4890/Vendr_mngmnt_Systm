...
class VendorRetrieveUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    queryset = Vendor.objects.all()
    serializer_class = VendorSerializer
    # lookup_field = 'vendor_code'  # Set the custom lookup field
...
def create(self, request, *args, **kwargs):
        instance = self.get_object()
        instance.acknowledgment_date = request.data.get('acknowledgment_date')  # Assuming 'acknowledgment_date' is a valid field in your model
        instance.save()
        ...
        total_seconds = sum(abs((ack_date - issue_date).total_seconds()) for ack_date, issue_date in response_times if ack_date and issue_date)
